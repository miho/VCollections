...
public interface CollectionObservable<T, CCE extends CollectionChangeEvent<T, CO, CC>, CO extends Collection<T>, CC extends CollectionChange<T>> {
     ...
     */
    CollectionChangeListener<T, CCE, CO, CC> addListChangeListener(CollectionChangeListener<T, CCE, CO, CC> l);
     ...
     * this list)
     */
    boolean removeListChangeListener(CollectionChangeListener<T, CCE, CO, CC> l);
}
